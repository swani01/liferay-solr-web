...
public class BasicAuthSolrServer extends StoppableSolrServer {
	...
	public BasicAuthSolrServer(AuthScope authScope, String username,
	...
	public void stop() {
		...
		while (true) {
			int connectionsInPool = _multiThreadedHttpConnectionManager
			...
			if (_log.isDebugEnabled()) {
				_log.debug(toString() + " waiting on " + connectionsInPool
						+ " connections");
			}
